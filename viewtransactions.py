...
def get_transactions():
    ...
    print(new_heading)
    new_list=[new_heading[7],new_heading[5],new_heading[2],new_heading[6],new_heading[0],new_heading[8],new_heading[1],new_heading[4],new_heading[3]]
    ...
    print(button_list)
    return render_template('t1.html',heading=new_list,records=result,row_id=id_list,zip=zip,button_id=button_list)
